...
USERNAME = environ.get('USERNAME', "https://t.me/Deep2213k") # ADMIN USERNAME
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002427494480'))
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/Moviesrequst1')
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002537474111').split()]
#---------------------------------------------------------------
#---------------------------------------------------------------
...
DATABASE_NAME = environ.get('DATABASE_NAME', "xewena6452")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'My_Tg_files')
#---------------------------------------------------------------
#---------------------------------------------------------------
#----------- There will be channel id add in all these ---------
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1002427494480'))  # set shortner log channel
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002545890634')
SUPPORT_GROUP = int(environ.get('SUPPORT_GROUP', '-1002216002151'))
request_channel = environ.get('REQUEST_CHANNEL', '-1002290453638') # If anyone sends a request message to your bot, you will get it in this channel.
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002537474111')) # 
...
#---------------------------------------------------------------
#---------------------------------------------------------------
START_IMG = (environ.get('START_IMG', 'https://telegra.ph/file/5ed708a888f16dd039358.jpg')).split()
FORCESUB_IMG = environ.get('FORCESUB_IMG', 'https://i.ibb.co/ZNC1Hnb/ad3f2c88a8f2.jpg')
REFER_PICS = (environ.get("REFER_PICS", "https://envs.sh/PSI.jpg")).split() 
PAYPICS = (environ.get('PAYPICS', 'https://graph.org/file/43a95b7ce7996be6a5555-e6f3315a0654d6ea4c.jpg')).split()
